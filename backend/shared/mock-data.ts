...
export const users: User[] = [
  { id: "u1", email: "you@learnrift.site", displayName: "Arjun Mehta", username: "arjun", avatarUrl: ava("arjun"), bio: "Final-year CS at IIT Bombay.", college: "IIT Bombay", roles: ["learner", "creator"], isVerified: true, createdAt: "2025-08-10T10:00:00Z" },
  { id: "u2", email: "ananya@learnrift.site", displayName: "Ananya Iyer", username: "ananya", avatarUrl: ava("ananya"), bio: "Teaching DSA without the gatekeeping.", college: "BITS Pilani", roles: ["creator", "learner"], isVerified: true, createdAt: "2024-12-01T10:00:00Z" },
  { id: "u3", email: "rohan@learnrift.site", displayName: "Rohan Kapoor", username: "rohan", avatarUrl: ava("rohan"), bio: "Backend nerd.", college: "NIT Trichy", roles: ["creator"], isVerified: true, createdAt: "2024-09-14T10:00:00Z" },
  { id: "u4", email: "sneha@learnrift.site", displayName: "Sneha Reddy", username: "sneha", avatarUrl: ava("sneha"), bio: "ML researcher.", college: "IIIT Hyderabad", roles: ["creator"], isVerified: true, createdAt: "2024-11-20T10:00:00Z" },
  { id: "u5", email: "vikram@learnrift.site", displayName: "Vikram Singh", username: "vikram", avatarUrl: ava("vikram"), bio: "Distributed systems.", college: "IIT Delhi", roles: ["creator"], isVerified: true, createdAt: "2024-07-04T10:00:00Z" },
  { id: "u6", email: "priya@learnrift.site", displayName: "Priya Sharma", username: "priya", avatarUrl: ava("priya"), college: "VIT Vellore", roles: ["learner"], isVerified: true, createdAt: "2025-02-10T10:00:00Z" },
  { id: "u7", email: "kabir@learnrift.site", displayName: "Kabir Khanna", username: "kabir", avatarUrl: ava("kabir"), college: "DTU", roles: ["learner"], isVerified: true, createdAt: "2025-03-15T10:00:00Z" },
  { id: "admin1", email: "admin@learnrift.site", displayName: "Platform Admin", username: "admin", avatarUrl: ava("admin"), roles: ["admin"], isVerified: true, createdAt: "2024-01-01T00:00:00Z" },
];
